...
[![CI](https://github.com/go-semantic-release/provider-gitea/actions/workflows/ci.yml/badge.svg)](https://github.com/go-semantic-release/provider-gitea/actions/workflows/ci.yml) ![Endpoint Badge](https://img.shields.io/endpoint?url=https%3A%2F%2Fbadges.cybercinch.nz%2Fgo-semantic-release%2Fprovider-gitea%2Fcoverage)
...
| slug | The owner and repository name                             | `--provider-opt slug=go-semantic-release/provider-gitea`            |
